...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "- Your first assistant message for any user recipe question must be a retrieve_docs tool call.\n"
        "- Use retrieve_docs before answering any factual question about recipes, ingredients, quantities, steps, timing, tools, comparisons, missing information, or ambiguity.\n"
        "- You must not answer, summarize, refuse, say 未找到, or ask clarification before retrieve_docs returns evidence.\n"
        "- Even if you believe the answer is obvious or absent, call retrieve_docs first.\n"
        "- Citations must never be guessed; citation ids must come from retrieve_docs chunks.\n"
